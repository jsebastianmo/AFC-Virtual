    ...
    <div className="card modulo">
      ...
      <div className="card-body">
        ...
        <div className='acciones'>
          <NavLink to="/clase/teologia" className="btn btn-success rounded-circle" data-bs-toggle="tooltip" data-bs-placement="top" title="Entrar"><i className="bi bi-box-arrow-right"></i></NavLink>
